...
<div class="calculator-container">
  ...
  <main class="container">
    <div class="calculator-header">
      ...
      <p>Calculate how much water your plants need based on their type, pot size, and environment.</p>
    </div>
    ...
    <div class="calculator-form-container">
      <form @submit.prevent="calculateWaterNeeds" class="calculator-form">
        ...
        <div class="form-group">
          ...
          <select id="sunlight" v-model="calculatorData.sunlight" class="form-input" required>
            ...
            <option value="low">Low (shade or indirect light)</option>
      ...
      <div v-if="showResults" class="calculator-results">
        <h2>Watering Recommendation</h2>
        
        <div class="result-card">
          <div class="result-item">
            <h3>Water Amount</h3>
            <p class="result-value">{{ waterAmount }} {{ waterUnit }}</p>
          </div>
          
          <div class="result-item">
            <h3>Frequency</h3>
            <p class="result-value">{{ frequencyText }}</p>
          </div>
        </div>
        ...
        <div class="watering-tips">
          <h3>Watering Tips</h3>
          <ul>
            <li v-for="(tip, index) in wateringTips" :key="index">
              {{ tip }}
            </li>
          </ul>
        </div>
...
methods: {
  calculateWaterNeeds() {
    ...
    switch(this.calculatorData.season) {
      ...
      case 'spring':
        waterAmount *= 1.1;
        frequencyDays = Math.floor(frequencyDays * 0.9);
        break;
    }
